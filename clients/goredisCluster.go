...
// NewGoRedisClusterClient -
func NewGoRedisClusterClient(ctx context.Context, conn *goredis.ClusterClient) *GoRedisCluster {
	if ctx == nil {
...
// 			 [NX | XX]
//
func (r *GoRedisCluster) JSONSet(key string, path string, obj interface{}, opts ...rjs.SetOption) (res interface{}, err error) {
	if len(opts) > 1 {
